...
import commercialHero from '@/assets/bg/commercial-roofing-section__hero.avif';
import stormHero from '@/assets/bg/storm-damage-repair-section__hero.avif';
import stoneCoatedHero from '@/assets/bg/stone-coated-steel-roofing-section__hero.avif';
import concreteTileHero from '@/assets/bg/concrete-tile-roof-section__hero.avif';
import metalHero from '@/assets/bg/metal-roofing-section__hero.avif';
import roofReplacementHero from '@/assets/bg/roof-replacement-section__hero.avif';
