      ...
      await getResend().emails.send({
        ...
        html: buildEmailHtml({
          ...
          fields: [
            ...
            { label: 'Phone', value: input.phone },
            { label: 'Email', value: input.email },
            { label: 'Home Type', value: input.homeType },
            { label: 'Project Timeline', value: input.timeline },
            { label: 'Project Scope', value: input.projectScope },
            { label: 'Street Address', value: input.streetAddress },
            { label: 'City', value: input.city },
            { label: 'Postal Code', value: input.postalCode },
            { label: 'Zip Code', value: input.zipCode },
            { label: 'Service Needed', value: input.service },
            { label: 'Landing Page', value: input.landingPage },
            { label: 'Page Path', value: input.pagePath },
            { label: 'UTM Source', value: input.utmSource },
            { label: 'UTM Medium', value: input.utmMedium },
            { label: 'UTM Campaign', value: input.utmCampaign },
            { label: 'UTM Content', value: input.utmContent },
            { label: 'UTM Term', value: input.utmTerm },
            { label: 'FBCLID', value: input.fbclid },
          ],
        }),
      });
      return { success: true };
