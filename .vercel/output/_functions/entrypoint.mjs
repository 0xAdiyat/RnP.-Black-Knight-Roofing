import './chunks/virtual_DvcSs0Oz.mjs';
import * as z from 'zod';
import { Resend } from 'resend';
import { d as defineAction } from './chunks/server_MgX7y8ru.mjs';

const resend = new Resend("re_8hTrEwun_BuQLeaiYRxHuuXcohxgHgMMt");
